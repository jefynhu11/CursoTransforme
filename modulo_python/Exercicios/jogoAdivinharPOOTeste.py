...
class JogoAdivinhar:
    ...
    def __init__(self, nome, inferior, superior, maxTentativa):
        self.nome = nome;
        self.inferior = inferior;
        self.superior = superior;
        self.maxTentativa = maxTentativa;
...
limite_inferior = int(input("Digite um numero inferior: "));
limite_superior = int(input("Digite um numero superior: "));
maxTentativa = int(input("Digite um numero quanto pode tentativa: "));
print("===========================");

jogador = JogoAdivinhar(nome, limite_inferior, limite_superior, maxTentativa);
